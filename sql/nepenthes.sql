-- SURFids 2.00.03
-- SURFids Nepenthes functions
-- Changeset 001
-- 22-05-2008
--

-- Changelog
-- 001 Added DROP's before CREATE's
--

CREATE PROCEDURAL LANGUAGE plpgsql;

--
-- DROPPING ALL EXISTING FUNCTIONS
--
DROP FUNCTION surfnet_attack_add (integer, inet, integer, inet, integer, macaddr, inet);
DROP FUNCTION surfnet_attack_add_by_id (integer, inet, integer, inet, integer, macaddr, integer);
DROP FUNCTION surfnet_attack_update_severity (integer, integer);
DROP FUNCTION surfnet_detail_add (integer, inet, integer, character varying);
DROP FUNCTION surfnet_detail_add_by_id (integer, integer, integer, character varying);
DROP FUNCTION surfnet_detail_add_download (inet, inet, character varying, character varying);
DROP FUNCTION surfnet_detail_add_offer (inet, inet, character varying);
DROP FUNCTION surfnet_sensorid_get (inet);
