...
-- Changelog
-- 006 Modified sensors_log
-- 005 Added changes to sensors, serverinfo
-- 004 Added ostypes table + system rule
-- 003 Added privileges for pofuser on scheme
-- 002 Removed stats_history tables (deprecated).
-- 001 version 2.00 (added logmessages, sensors_log, removed searchtemplates, arp_alerts)
