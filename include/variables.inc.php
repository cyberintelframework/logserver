...
#############################################
# Changelog:
# 004 Added v_timestamp_format_ar and modified some others
# 003 Added extra detail type
# 002 Removed unused arrays
# 001 added v_weekdays
#############################################
...
# Array with the different OS languages for Argos images
$v_os_languages = array(
        'nl' => "Dutch",
        'en' => "English"
);

# Array with types of view for sensorstatus page
$v_selview_ar = array(
        0 => "View all sensors",
...
# Array with the different timestamp formats for maillogging
