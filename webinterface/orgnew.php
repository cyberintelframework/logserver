...
if ($err != 1) {
  ...
  echo "<form action='orgsave.php' method='POST'>\n";
    echo "<table class='datatable'>\n";
      ...
      echo "</tr>\n";
      echo "<tr>\n";
        echo "<td class='datatd' valign='top'>Ranges<br />IP ranges separated by &ldquo;;&ldquo;</td>\n";
        echo "<td class='datatd'><textarea name='f_ranges' cols='40' rows='6'>$ranges</textarea></td>\n";
      echo "</tr>\n";
      echo "<tr>\n";
