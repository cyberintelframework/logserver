...
$action_pattern = '/^(NONE|REBOOT|SSHOFF|SSHON|RESTART|DISABLE|ENABLE|START|STOP|IGNORE|UNIGNORE|ENABLEARP|DISABLEARP|ACTIVATE|DEACTIVATE|SENSORUPGRADE|APTUPGRADE|DEPUPGRADE|APTCOUNT)$/';
