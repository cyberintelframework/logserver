...
#############################################
# Changelog:
# 003 Added UTC and Always send options
# 002 Fixed Bug with detail display in int_sdetail 
# 001 version 2.00
#############################################
        ...
        echo "<div class='blockContent'>\n";
          echo "<table class='datatable'>\n";
            ...
            if ($detail == 4 || $detail == 5) {
              ...
              echo "<td width='100'>Filter:</td>\n";
              echo "<td width='200'>";
                echo "<select name='int_filter' id='int_filter'>\n";
                  echo printOption(0, "Exclude own IP ranges", $sev);
                  echo printOption(1, "Include own IP ranges", $sev);
                echo "</select>\n";
              echo "</td>\n";
            echo "</tr>\n";
            ...
            if ($detail == 4 || $detail == 5) {
              ...
              echo "<td width='100'>Timestamps format:</td>\n";
              echo "<td width='200'>";
