      ...
      echo "<div class='blockContent'>\n";
        echo "<table class='datatable'>\n";
          echo "<tr>\n";
            ...
            echo "<td><input type='text' size='45' name='strip_html_escape_subject' /></td>\n";
          echo "</tr>\n";
          echo "<tr>\n";
  ...
  echo "<div class='block'>\n";
    echo "<div class='dataBlock'>\n";
      ...
      echo "<div class='blockContent'>\n";
        echo "<table class='datatable'>\n";
          echo "<tr>\n";
            echo "<td width='130'>" .$l['g_sensor']. "</td>\n";
            echo "<td>\n";
          ...
          echo "<tr style='display:;' id='repdetail' name='repdetail'>";
            echo "<td>" .$l['re_reptype']. " " .printhelp(17,17). "</td>\n";
            echo "<td>";
          ...
          echo "<tr style='display:none;' id='srepdetail' name='srepdetail'>";
            echo "<td>" .$l['re_reptype']. " " .printhelp(17,17-2). "</td>\n";
            echo "<td>";
          ...
          echo "<tr style='display: none;' id='rss_pub' name='rss_pub'>";
            ...
            echo "<td>";
              echo "<input id='int_public' type='checkbox' style='cursor: pointer;' value='t' name='int_public' onclick='pubwarn();' />";
        ...
        echo "<div class='dataBlock'>\n";
          ...
          echo "<div class='blockContent'>\n";
            echo "<table class='datatable'>\n";
              ...
              echo "</tr>\n";
              echo "<tr>\n";
                echo "<td>" .$l['re_thresh_amount']. "</td>\n";
                echo "<td><input type='text' name='int_threshold' /></td>\n";
              echo "</tr>\n";
              echo "<tr>\n";
                echo "<td>" .$l['re_timespan']. "</td>\n";
                echo "<td>";
