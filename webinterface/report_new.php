      ...
      echo "<div class='blockContent'>\n";
        echo "<table class='datatable'>\n";
          echo "<tr>\n";
            ...
            echo "<td width='200'><input type='text' size='41' name='strip_html_escape_subject' /></td>\n";
          echo "</tr>\n";
          echo "<tr>\n";
  ...
  echo "<div class='block'>\n";
    echo "<div class='dataBlock'>\n";
      ...
      echo "<div class='blockContent'>\n";
        echo "<table class='datatable'>\n";
          echo "<tr>\n";
            echo "<td width='100'>" .$l['g_sensor']. "</td>\n";
            echo "<td width='200'>\n";
          ...
          echo "<tr style='display:;' id='repdetail' name='repdetail'>";
            echo "<td width='100'>" .$l['re_reptype']. " " .printhelp(17,17). "</td>\n";
            echo "<td width='200'>";
          ...
          echo "<tr style='display:none;' id='srepdetail' name='srepdetail'>";
            echo "<td width='100'>" .$l['re_reptype']. " " .printhelp(17,17-2). "</td>\n";
            echo "<td width='200'>";
