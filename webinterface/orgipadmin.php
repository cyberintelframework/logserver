...
####################################
# Changelog:
# 004 Added md5_hash to orgipdel.php url
# 003 Fixed a bug with adding new exclusions as non-admin
# 002 Layout stuff
# 001 Initial release
####################################
          ...
          echo "<form name='orgadmin' action='orgipadd.php' method='post'>\n";
            echo "<table class='datatable'>\n";
              ...
              while ($row = pg_fetch_assoc($result_ex)) {
                ...
                echo "<tr>\n";
                  echo "<td>$excl</td>\n";
                  echo "<td><a href='orgipdel.php?int_id=$id&int_orgid=$q_org&md5_hash=$s_hash' onclick=\"javascript: return confirm('Are you sure you want to delete this record?');\">[Delete]</a></td>\n";
                echo "</tr>\n";
              }
              echo "<tr>\n";
