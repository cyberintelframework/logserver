...
#########################################################################
# Changelog:
# 006 Fixed criterea bug #24 + added new inet_ownsource  
# 006 BUG #42 + #43 fixed  
# 005 Criterea BUG fixed  
# 004 No additional info for ARP attacks
# 003 Fixed a bug in the navigation
# 002 Changed the info you see with Rogue DHCP attacks
# 001 version 2.00 
#########################################################################
  ...
  echo "<div class='block'>";
      ...
      echo "<div class='blockContent'>\n";
        ...
        echo "<table class='actiontable'>\n";
          ...
          echo "<tr>\n";
            ...
            echo "<th width='52%'>\n";
              if (!isset($source_ip) && !isset($source_mac) && !isset($ownsource)) echo "ALL ";
              if ($f_sourcechoice == 3 && !isset($ownsource)) echo "Own Ranges";
	...
	echo "</table>\n";
        ...
        echo "<table class='actiontable'>\n";
	      ...
	      if (isset($f_sevtype) && $f_sev == 1) echo "Severity Type: <font class='btext'>$v_severity_atype_ar[$f_sevtype]</font><br />";
              ...
              if (isset($f_binname) && $f_sev == 32) echo "Binary Name: <font class='btext'>$f_binname</font><br />";
              if (isset($f_virus_txt) && $f_sev == 32) echo "Virus: <font class='btext'>$f_virus_txt</font><br />";
              if (isset($f_filename) && ($f_sev == 32 || $f_sev == 16)) echo "Filename: <font class='btext'>$f_filename</font><br />";
            echo "</td>\n";
            echo "<td width='2%'></td>\n";
          echo "</tr>\n";
        echo "</table>\n";
