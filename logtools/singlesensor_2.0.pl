...
if (! -e "/etc/surfnetids/surfnetids-tn.conf") {
  `svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/surfnetids-tn.conf /etc/surfnetids/surfnetids-tn.conf`;
  printmsg("Downloading surfnetids-tn.conf:", $?);
}

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/scripts/rrd_traffic.pl $c_surfidsdir/scripts/rrd_traffic.pl`;
printmsg("Downloading rrd_traffic.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/scripts/rrd_serverinfo.pl $c_surfidsdir/scripts/rrd_serverinfo.pl`;
printmsg("Downloading rrd_serverinfo.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/scripts/detectarp.pl $c_surfidsdir/scripts/detectarp.pl`;
printmsg("Downloading detectarp.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/scripts/scanbinaries.pl $c_surfidsdir/scripts/scanbinaries.pl`;
printmsg("Downloading scanbinaries.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/scripts/types_data.pl $c_surfidsdir/scripts/types_data.pl`;
printmsg("Downloading types_data.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/tntools/update_oui.pl $c_surfidsdir/logtools/update_oui.pl`;
printmsg("Downloading update_oui.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/tntools/localsensor.pl $c_surfidsdir/logtools/localsensor.pl`;
printmsg("Downloading localsensor.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/scripts/tnfunctions.inc.pl $c_surfidsdir/scripts/tnfunctions.inc.pl`;
printmsg("Downloading tnfunctions.inc.pl:", $?);

`svn export https://svn.ids.surfnet.nl/surfids/2.0/tunnel/tags/stable-2.00.01/crontab.tn $c_surfidsdir/crontab.tn`;
